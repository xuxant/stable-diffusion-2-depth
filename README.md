...
This repo gives a basidsdsc framework for serving Stable Diffusion Img2Depth pipeline in production using simple HTTP servers.
...
## Quickstart:
cdd
The repo is already set up to run [Stable Diffusion Img2Depth](https://huggingface.co/stabilityai/stable-diffusion-2-depth) image-to-image model.
